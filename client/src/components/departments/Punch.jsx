...
export const Punch = () => {
    ...
    const fetchData = async () => {
        try {
            const [allJobs, tbrJobs, frJobs, punchMaterials] = await Promise.all([
                getAllJobs(),
                getTBRJobs(),
                getFRJobs(),
    ...
    const handleSave = () => {
        createMaterial(programNo, material, jobNo, 'punch', 'punch')
        setShow(false);
        fetchData();
    };
                        ...
                        <Modal.Body className="text-center">
                            <Form>
                                ...
                                <FloatingLabel label="Area" className="mb-3">
                                    <Form.Control defaultValue="Punch" disabled />
                                </FloatingLabel>
                            </Form>
                        </Modal.Body>
